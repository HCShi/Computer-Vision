...
%imgList = dir('/Users/haichao/Desktop/ImageProcessing/data/campus*.jpg');
%imgList = dir('/Users/haichao/Desktop/ImageProcessing/data/pine*.jpg');
%imgList = dir('/Users/haichao/Desktop/ImageProcessing/data/trees*.jpg');
imgList = dir('/Users/haichao/Desktop/ImageProcessing/data/uttower*.jpg');
%imgList = dir('/Users/haichao/Desktop/ImageProcessing/data/watering_cart*.jpg');
%imgList = dir('/Users/haichao/Desktop/ImageProcessing/data/yard*.jpg');
%imgList = dir('/Users/haichao/Desktop/ImageProcessing/data/yosemite*.jpg');
%imgList = dir('/Users/haichao/Desktop/ImageProcessing/data/building*.jpg')
...
for i = 1 : length(imgList),
    IMAGES{i} = imread(['/Users/haichao/Desktop/ImageProcessing/data/' imgList(i).name]);
...
for i = 1 : length(imgList),
    [feature, ~, imp] = detect_features_Harris_Laplace(IMAGES{i});
    %[feature, ~, imp] = detect_features_DoG(IMAGES{i});
